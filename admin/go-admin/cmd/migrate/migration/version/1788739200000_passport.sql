...
CREATE TABLE "products" (
  ...
  "created_at" TEXT NOT NULL CHECK (length("created_at")=24 AND substr("created_at",24,1)='Z' AND julianday("created_at") IS NOT NULL),
  "created_by" INTEGER NOT NULL,
  "updated_at" TEXT NOT NULL CHECK (length("updated_at")=24 AND substr("updated_at",24,1)='Z' AND julianday("updated_at") IS NOT NULL),
  ...
  "archived_at" TEXT CHECK (length("archived_at")=24 AND substr("archived_at",24,1)='Z' AND julianday("archived_at") IS NOT NULL),
...
CREATE TABLE "product_revisions" (
  ...
  "sealed_at" TEXT CHECK (length("sealed_at")=24 AND substr("sealed_at",24,1)='Z' AND julianday("sealed_at") IS NOT NULL),
  "sealed_by" INTEGER,
...
CREATE TABLE "batches" (
  ...
  "submitted_at" TEXT CHECK (length("submitted_at")=24 AND substr("submitted_at",24,1)='Z' AND julianday("submitted_at") IS NOT NULL),
  "submitted_by" INTEGER,
  "reviewed_at" TEXT CHECK (length("reviewed_at")=24 AND substr("reviewed_at",24,1)='Z' AND julianday("reviewed_at") IS NOT NULL),
  "reviewed_by" INTEGER,
...
CREATE TABLE "media_assets" (
  ...
  "internal_note" TEXT CHECK (length("internal_note")<=2000),
  "purged_at" TEXT CHECK (length("purged_at")=24 AND substr("purged_at",24,1)='Z' AND julianday("purged_at") IS NOT NULL),
...
CREATE TABLE "passport_revisions" (
  ...
  "sealed_at" TEXT CHECK (length("sealed_at")=24 AND substr("sealed_at",24,1)='Z' AND julianday("sealed_at") IS NOT NULL),
  "published_at" TEXT CHECK (length("published_at")=24 AND substr("published_at",24,1)='Z' AND julianday("published_at") IS NOT NULL),
  "published_by" INTEGER NOT NULL,
  "reviewed_by" INTEGER NOT NULL,
  "reviewed_at" TEXT NOT NULL CHECK (length("reviewed_at")=24 AND substr("reviewed_at",24,1)='Z' AND julianday("reviewed_at") IS NOT NULL),
...
CREATE TABLE "publish_records" (
  ...
  "started_at" TEXT CHECK (length("started_at")=24 AND substr("started_at",24,1)='Z' AND julianday("started_at") IS NOT NULL),
  "completed_at" TEXT CHECK (length("completed_at")=24 AND substr("completed_at",24,1)='Z' AND julianday("completed_at") IS NOT NULL),
  "switched_at" TEXT CHECK (length("switched_at")=24 AND substr("switched_at",24,1)='Z' AND julianday("switched_at") IS NOT NULL),
  "updated_at" TEXT NOT NULL CHECK (length("updated_at")=24 AND substr("updated_at",24,1)='Z' AND julianday("updated_at") IS NOT NULL),
