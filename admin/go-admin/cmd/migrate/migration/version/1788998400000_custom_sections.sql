...
INSERT INTO t7_audit_events SELECT * FROM passport_audit_events;
DROP TABLE passport_audit_events;
ALTER TABLE t7_audit_events RENAME TO passport_audit_events;
...
ALTER TABLE custom_sections ADD COLUMN allow_hide INTEGER NOT NULL DEFAULT 0 CHECK(allow_hide IN (0,1));
