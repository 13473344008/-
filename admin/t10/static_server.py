...
import re,os
ROOT=Path(__file__).resolve().parents[2]/'runtime/t10/publish'
...
print('T10 static files only, localhost:19538',flush=True)
ThreadingHTTPServer(('127.0.0.1',19538),Handler).serve_forever()
